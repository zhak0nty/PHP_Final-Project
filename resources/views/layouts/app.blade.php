        ...
        <div class="min-h-screen flex flex-col">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 lg:h-18 items-center justify-between">
                        ...
                        <nav class="hidden md:flex items-center justify-center gap-8 flex-1 px-8">
                            <a href="{{ route('home') }}" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8] transition-colors">Home</a>
                            <a href="{{ route('home') }}#services" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8] transition-colors">Services</a>
                            <a href="{{ route('specialists.index') }}" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8] transition-colors">Doctors</a>
                            <a href="{{ route('reviews.index') }}" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8] transition-colors">Reviews</a>
                            <a href="{{ route('dashboard') }}" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8] transition-colors">Booking</a>
                        </nav>
                        ...
                        <div class="flex items-center gap-3 shrink-0">
                            @auth
                                ...
                                <form method="POST" action="{{ route('logout') }}" class="inline">
                                    @csrf
                                    <button type="submit" class="rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">Log out</button>
                                </form>
                            @else
                                <a href="{{ route('login') }}" class="text-sm font-medium text-gray-700 hover:text-[#6B21A8]">Log in</a>
            ...
            <footer class="border-t border-gray-200 bg-white mt-auto">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
                    ...
                    <span>Demo: admin@example.com · client@example.com · doctor1@example.com (password: password)</span>
                </div>
            </footer>
        </div>
