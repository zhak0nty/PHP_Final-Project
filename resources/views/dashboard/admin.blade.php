...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Обзор врачей, услуг и расписания. CRUD доступен через API.</p>
        </div>
        <div class="grid gap-6 lg:grid-cols-3 items-start">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Расписание (время приёма)</h2>
                <div class="space-y-3 max-h-[360px] overflow-y-auto">
