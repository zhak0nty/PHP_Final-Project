...
@section('title', ($page['title'] ?? 'Information') . ' — MedBooking')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
            <div class="grid gap-8 lg:grid-cols-[minmax(0,2fr),minmax(0,1fr)] items-start">
                ...
                <aside class="rounded-2xl border border-gray-200 bg-gray-50/80 p-6 lg:sticky lg:top-24">
                    <div class="text-sm font-semibold text-gray-900">Booking</div>
                    <p class="mt-2 text-sm text-gray-600">
                        You can book without registering: enter your name, email, and phone — that is all you need.
                    </p>
            ...
            <div class="mt-10 grid gap-8 lg:grid-cols-2">
                <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <h2 class="text-lg font-semibold text-gray-900">When to choose this</h2>
                ...
                <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <h2 class="text-lg font-semibold text-gray-900">What we use</h2>
            ...
            @if ($slug === 'narrow-directions' && !empty($specializations) && $specializations->isNotEmpty())
                <section class="mt-10 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <h2 class="text-lg font-semibold text-gray-900">Specialties</h2>
                    ...
                    <p class="mt-4 text-sm text-gray-600">
                        Go to the specialists page to pick a doctor by specialty and book.
                    </p>
            ...
            <section class="mt-10">
                <div class="flex items-end justify-between gap-4">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">Specialists</h2>
                        <p class="mt-1 text-sm text-gray-600">Choose a doctor and book a convenient time.</p>
                    </div>
                ...
                @if ($doctors->isEmpty())
                    <p class="mt-4 text-gray-500">No specialists for this area yet.</p>
                @else
                            ...
                            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-[#6B21A8]/30 transition-all">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <div class="mt-1 text-sm text-gray-600">{{ $doctor->specialization ?? 'General practice' }}</div>
                                    </div>
